 ...
 * Cuckoo Hash Map
 * <p>
 * Implementation of Map interface using Cuckoo Hashing. Using two hash functions instead of single hash function to determine the possible location
 * of an entry in the map. An entry is allocated in one of the two possible location of for the key, kicking out any previous entry from the position
 * if present. The key thrown out now imitates behavior of the new entry and tries to accomodate itself in one of the two possible locations. This
 * process may result in an infinite loop, in which case, the underlying data structure is re-hashed and all the keys from the old data structure is
 * re-mapped to their preferred locations in the new data structure.
 * <p>
 * In this simplified implementation, we take a array data structure, each key value pair represented by an Entry<K, V>. Two hash functions hash1 and
 * hash2 are used to determine index position to insert an entry to table.
 */
...
//      CuckooHashMap<String, String> cuckooHashMap = new CuckooHashMap<>();
//      cuckooHashMap.put("1", "String");
//      cuckooHashMap.put("2", "String");
//      cuckooHashMap.put("3", "String");
//      cuckooHashMap.put("4", "String");
//      cuckooHashMap.put("5", "String");
//      cuckooHashMap.put("6", "String");
//      cuckooHashMap.put("7", "String");
